...
public class Robot extends TimedRobot {
  ...
  static private double ENCODER_EDGES_PER_REV = 2048;  // MJS: was int, but that caused encoderConstant to be zero
  static private int PIDIDX = 0;
  // static private int ENCODER_EPR = 2048; // MJS: unused
  ...
  public void robotInit() {
    ...
    // create left motor
    WPI_TalonFX leftMotor = setupWPI_TalonFX(0, Sides.LEFT, true);

    WPI_TalonFX leftFollowerID15 = setupWPI_TalonFX(15, Sides.FOLLOWER, false);
    leftFollowerID15.follow(leftMotor);
